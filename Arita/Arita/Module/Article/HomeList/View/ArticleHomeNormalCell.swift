...
class ArticleHomeNormalCell: UITableViewCell {
    ...
    public var picUrl = "" {
        didSet {
            picView.kf.setImage(with: URL(string: picUrl), placeholder: UIImage(named: Icon.placeHolderArticle32), options: [.transition(.fade(1.5))], progressBlock: nil, completionHandler: nil)
        }
    }
