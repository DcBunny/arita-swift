 ...
 ** 获取良品首页列表
 */
class GoodsListManager: ONAPIBaseManager {
    override init() {
        super.init()
...
extension GoodsListManager: ONAPIManager {
    func methodName() -> String {
        return "get_new_goods"
    }
...
extension GoodsListManager: ONAPIManagerValidator {
