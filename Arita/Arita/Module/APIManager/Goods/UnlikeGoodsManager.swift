 ...
 ** 删除收藏良品
 */
class UnlikeGoodsManager: ONAPIBaseManager {
    override init() {
        super.init()
...
extension UnlikeGoodsManager: ONAPIManager {
    func methodName() -> String {
        return "del_like_goods"
    }
...
extension UnlikeGoodsManager: ONAPIManagerValidator {
