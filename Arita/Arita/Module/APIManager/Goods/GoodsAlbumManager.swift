 ...
 ** 获取良品专辑详情
 */
class GoodsAlbumManager: ONAPIBaseManager {
    override init() {
        super.init()
...
extension GoodsAlbumManager: ONAPIManager {
    func methodName() -> String {
        return "goods_album_detail"
    }
...
extension GoodsAlbumManager: ONAPIManagerValidator {
