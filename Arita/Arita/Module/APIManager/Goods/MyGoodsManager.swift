 ...
 ** 删除收藏良品
 */
class MyGoodsManager: ONAPIBaseManager {
    override init() {
        super.init()
...
extension MyGoodsManager: ONAPIManager {
    func methodName() -> String {
        return "get_like_goods"
    }
...
extension MyGoodsManager: ONAPIManagerValidator {
