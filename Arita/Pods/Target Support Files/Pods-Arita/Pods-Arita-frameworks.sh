...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ONCountDownButton/ONCountDownButton.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ONFoundation/ONFoundation.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ONPlaceholder/ONPlaceholder.framework"
